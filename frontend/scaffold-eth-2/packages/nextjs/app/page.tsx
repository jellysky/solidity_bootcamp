...
function ApiData(params: {proposal: number; amount: string; address: `0x${string}` }) {
  return (
    <div className="card w-96 bg-primary text-primary-content mt-4">
      ...
      <div className="card-body">
        <h2 className="card-title">Requesting Tokens ... </h2>
      ...
      <div className="card-body">
        ...
        <Delegate address={params.address}></Delegate>
        
      </div>

      <div className="card-body">
        <h2 className="card-title">Getting Votes ... </h2>
      ...
      <div className="card-body">
        ...
        <Vote proposal={1} amount={"17"} ></Vote>
...
function Delegate(params: { address: string }) {
  ...
  if (isLoading) return <p>Delegating votes via API...</p>;
  if (!data)
    return (
      <button
        className="btn btn-active btn-neutral"
...
function Vote(params: {proposal: number, amount: string }) {
  ...
  if (isLoading) return <p>Voting via API...</p>;
  if (!data)
    return (
      <button
        className="btn btn-active btn-neutral"
